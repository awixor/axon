...
export function NewSpaceDialog({ open, onOpenChange }: NewSpaceDialogProps) {
  ...
  const [color, setColor] = useState<SpaceColor>(SPACE_COLOR_PRESETS[0]);
  const [visibility, setVisibility] = useState<SpaceVisibility>(
    SpaceVisibility.PrivateToTeam,
  );
  ...
  function reset() {
    ...
    setVisibility(SpaceVisibility.PrivateToTeam);
  }
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder="e.g. Frontend Standards"
                maxLength={100}
                required
                autoFocus
              />
